...
class ProviderFragmentModule {
  ...
  @ForFragment @Provides fun provideSourceDataSet(): ObservableList<Source> = ObservableList()

  @ForFragment @Provides fun provideNewsDataSet(): ObservableList<News> = ObservableList()
}