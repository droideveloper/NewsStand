...
data class NewsModel(override val state: SyncState, override val data: List<News>, val totalSize: Int, val changeState: News = News.EMPTY): Model<List<News>>(state, data)