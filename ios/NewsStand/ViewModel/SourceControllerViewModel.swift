//
//  SourceControllerViewModel.swift
//  NewsStand
//
...
class SourceControllerViewModel: BaseViewModel<SourceModel> {
  
  private weak var view: SourceController?

  init(view: SourceController) {
    self.view = view
  }
